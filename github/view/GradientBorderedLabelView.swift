...
public class GradientBorderedLabelView: UIView {
    ...
    func configure() {
        ...
        textLayer.truncationMode = .middle //kCAAlignmentCenter
...
public class CenteredTextLayer: CATextLayer {
    ...
    public override init() {
        super.init()
        self.alignmentMode = .center//kCAAlignmentCenter
    }
...
extension String {
    ...
    func height(withConstrainedWidth width: CGFloat, font: UIFont = Res.font.normal) -> CGFloat {
    ...
    func width(withConstrainedHeight height: CGFloat, font: UIFont = Res.font.normal) -> CGFloat {
