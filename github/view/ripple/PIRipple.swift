...
public class Ripple {
    ...
    private class func perform(_ view: UIView, point: CGPoint, option: Ripple.Option, then: @escaping () -> ()) {
        ...
        opacity.fillMode = .forwards //kCAFillModeForwards
        opacity.isRemovedOnCompletion = false //removedOnCompletion = false
        ...
        transform.fillMode = .forwards // kCAFillModeForwards
        transform.isRemovedOnCompletion = false//.removedOnCompletion = false
